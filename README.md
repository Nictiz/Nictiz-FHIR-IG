...
## How to run
* Clone this repo next to wherever you have cloned the STU3 repository. It might be a good idea to rename the resulting folder to align with the target repo (for example, 'Nictiz-FHIR-IG-Zib2017 when targeting the 'Zib2017' repo).
