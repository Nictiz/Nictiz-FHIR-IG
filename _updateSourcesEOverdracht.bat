...
SET nictiz_input_source=../Nictiz-STU3-eOverdracht
IF EXIST %nictiz_input_source% (
    ...
    java -cp %input_cache_path%/%publisher_jar% net.sf.saxon.Transform -xsl:eOverdracht.xsl -s:eOverdracht.xsl -o:input/myig.xml
) ELSE (
